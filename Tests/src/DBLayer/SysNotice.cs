...
/// 系统通知公告表
/// </summary>
[SugarTable("HH_SysNotice", "系统通知公告表")]
[SysTable]
public class SysNotice : EntityBase
{
    ...
    [SugarColumn(ColumnDescription = "消息位置")]

    public string? MsgPosition { get; set; }

    [SugarColumn(ColumnDescription = "提示时间")]

    public int? MsgDuration { get; set; }
}