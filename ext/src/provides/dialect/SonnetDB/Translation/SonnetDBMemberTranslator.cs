...
/// <summary>SonnetDB MemberTranslator：DatePart/DateAdd 走 Pure <see cref="SQLExpression"/>（首期最小）。</summary>
public class SonnetDBMemberTranslator : DefaultMemberTranslator
{
