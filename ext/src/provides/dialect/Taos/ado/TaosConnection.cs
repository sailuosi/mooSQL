...
using System.Linq;
using mooSQL.data.taos.Driver;
using System.Collections;
using mooSQL.data.taos.Protocols;
using mooSQL.data.taos.Protocols.TDRESTful;
...
namespace mooSQL.data.taos
{
    ...
    public partial class TaosConnection : DbConnection
    {
        ...
        /// <remarks>当使用WebSocket协议时会自动重新连接数据库。</remarks>
        ...
        public bool DatabaseExists(string databaseName)
        {
            ...
            return (bool)(ds?.Any(d => d.Database == databaseName));
        }
        /// <summary>
