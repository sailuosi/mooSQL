...
namespace mooSQL.linq.Tools
{
	...
	public enum ActivityID
	{
		...
		/// <summary>
		/// Alternative implementation of < cref="linq.DataExtensions.InsertOrReplace{T}(IDataContext,T,InsertOrUpdateColumnFilter{T}?,string?,string?,string?,string?,TableOptions)"/> method.
		/// </summary>
