...
namespace mooSQL.linq.Extensions
{
	...
	public static class AttributesExtensions
	{
			...
			where T : Attribute
		{
			...
			return results == null ? new T[] { } : results.ToArray();
		}
...
#pragma warning restore RS0030 // Do not used banned APIs
				...
				return res.Length == 0 ? new Attribute[] { } : res is Attribute[] attrRes ? attrRes : res.Cast<Attribute>().ToArray();
			});
			return attrs;
		}
			...
			var attrs = _inheritAttributes.GetOrAdd(source, static source =>
			{
				...
				if (attrs != null)
				{
					...
					if (attrs is Attribute[] arr)
						return arr.Length == 0 ? new Attribute[] { } : arr;
