...
namespace mooSQL.linq.Expressions
{
	...
	{
		private static readonly Type[] _wrapperConstructorParameters1 = new Type[] { typeof(object) };
		private static readonly Type[] _wrapperConstructorParameters2 = new Type[] { typeof(object), typeof(Delegate[]) };
		...
		private void BuildEnumConverters(Type wrapperType, Type originalType)
		{
			...
			if (hasDifferentValues)
			{
				...
				var wrapperToOriginal = w2oType.GetConstructor(new Type[] { })!.Invoke(new Type[] { });
				var originalToWrapper = o2wType.GetConstructor(new Type[] { })!.Invoke(new Type[] { });
