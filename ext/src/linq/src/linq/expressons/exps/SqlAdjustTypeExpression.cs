...
namespace mooSQL.linq.Expressions
{
    ...
    class SqlAdjustTypeExpression: Expression, IEquatable<SqlAdjustTypeExpression>
	{
		...
		public SqlAdjustTypeExpression(Expression expression, Type type, DBInstance mappingSchema)
		{
			_type         = type;
		...
		public static Expression AdjustType(Expression expression, Type type, DBInstance mappingSchema)
		{
		...
		public Expression Update(Expression expression)
		{
			...
			return AdjustType(expression, Type, DBLive);
		}
