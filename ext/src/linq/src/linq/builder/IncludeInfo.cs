...
namespace mooSQL.linq.Linq.Builder
{
	...
	sealed class IncludeInfo
	{
		...
		public IncludeInfo(MemberInfo memberInfo, bool shouldLoad)
		{
		...
		public List<IncludeInfo>? NextInfos { get; set; }

		private bool Equals(IncludeInfo other)
		{
		...
		IEnumerable<MemberInfo[]> EnumerateChains(MemberInfo[] currentPath, List<IncludeInfo> items)
		{
