...
namespace mooSQL.linq.Linq.Builder
{
	...
	{
		internal FirstSingleContext(IClauseContext? parent, IClauseContext sequence, FirstSingleMethodKind methodKind,
		...
		public override Expression BuildProjection(Expression path, ProjectFlags flags)
		{
			...
			var projected = base.BuildProjection(path, flags);
