...
namespace mooSQL.linq.Linq.Builder
{
	...
	class SubQueryContext : ClauseContextBase
	{
		public SubQueryContext(IClauseContext subQuery, SelectQueryClause selectQuery, bool addToSql)
		...
		public SubQueryContext(IClauseContext subQuery, bool addToSql = true)
			: this(subQuery, new SelectQueryClause(), addToSql)
		{
		}

		public          IClauseContext SubQuery      { get; }
		...
		public override Expression BuildProjection(Expression path, ProjectFlags flags)
		{
			...
			{
				var processed = Builder.BuildProjection(SubQuery, corrected, flags);
				return processed;
			}
