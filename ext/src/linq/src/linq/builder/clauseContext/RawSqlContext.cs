...
namespace mooSQL.linq.Linq.Builder
{
	...
	static class TableRawSqlHelper
	{
		public static BuildSequenceResult BuildRawSqlTable(ClauseSqlTranslator builder, BuildInfo buildInfo, bool isScalar)
		{
			...
			var sqlArguments = new IExpWord[arguments.Count];
				...
				else
				{
					...
					else
					{
						...
						for (var i = 0; i < array.Length; i++)
						{
							...
							if (typeof(IExpWord).IsAssignableFrom(type))
							{
