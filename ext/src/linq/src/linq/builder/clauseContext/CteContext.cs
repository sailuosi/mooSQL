...
namespace mooSQL.linq.Linq.Builder
{
	...
	internal class CteContext : ClauseContextBase
	{
		...
		public IClauseContext?   CteInnerQueryContext { get; private set; }
		public SubQueryContext? SubqueryContext      { get; private set; }
		public CTEClause        CteClause            { get; private set; }

		public CteContext(ClauseSqlTranslator builder, IClauseContext? cteInnerQueryContext, CTEClause cteClause, Expression cteExpression)
		...
		public void InitQuery()
		{
			...
			var cteBuildInfo = new BuildInfo((IClauseContext?)null, Expression!, new SelectQueryClause());
