...
namespace mooSQL.linq.Linq.Builder
{
	...
	{
		public static (IClauseContext deleted, IClauseContext inserted, TableWord deletedTable, TableWord insertedTable) CreateDeletedInsertedContexts(ClauseSqlTranslator builder, ITableContext targetTableContext, out IClauseContext outputContext)
		{
			var outputSelectQuery = new SelectQueryClause();

			IClauseContext deletedContext;
			IClauseContext insertedContext;
		...
		internal static void InitializeSetExpressions(
			...
			IClauseContext               fieldsContext,
			IClauseContext               valuesContext,
