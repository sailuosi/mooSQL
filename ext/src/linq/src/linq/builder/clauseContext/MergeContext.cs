...
namespace mooSQL.linq.Linq.Builder
{
	...
	{
		public MergeContext(MergeSentence merge, IClauseContext target)
			: base(null, target, null)
		{
			Merge = merge;
		}

		public MergeContext(MergeSentence merge, IClauseContext target, TableLikeQueryContext source)
		...
		public IClauseContext? OutputContext  { get; set; }
		...
		internal static TableWord? GetTargetTable(IClauseContext target)
		{
