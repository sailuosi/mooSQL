...
namespace mooSQL.linq.Linq.Builder
{
    ...
    internal sealed class CteTableContext: ClauseContextBase, ITableContext
	{
		...
		public IncludeInfo  IncludeRoot { get; set; } = new();
		public MemberInfo[]? IncludePath { get; set; }

		public CteTableContext(ClauseSqlTranslator builder, IClauseContext? parent, Type objectType, SelectQueryClause selectQuery, CteContext cteContext, bool isTest)
		...
		CteTableContext(ClauseSqlTranslator builder, IClauseContext? parent, Type objectType, SelectQueryClause selectQuery)
