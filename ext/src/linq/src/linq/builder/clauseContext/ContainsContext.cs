...
namespace mooSQL.linq.Linq.Builder
{
	...
	internal sealed class ContainsContext : ClauseContextBase
	{
		public override Expression Expression { get; }

		SelectQueryClause OuterQuery { get; }
		IClauseContext InnerSequence { get; }

		readonly MethodCallExpression _methodCall;

		public ContainsContext(IClauseContext? parent, MethodCallExpression methodCall, SelectQueryClause outerQuery, IClauseContext innerSequence)
		...
		public override IClauseContext? GetContext(Expression expression, BuildInfo buildInfo) => this;
