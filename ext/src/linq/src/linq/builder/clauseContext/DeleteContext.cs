...
namespace mooSQL.linq.Linq.Builder
{
	...
	internal sealed class DeleteContext : PassThroughContext
	{
		...
		public IClauseContext QuerySequence => Context;

		public DeleteTypeEnum     DeleteType       { get; }
		public IClauseContext?     DeletedContext   { get; }
		public LambdaExpression?  OutputExpression { get; }
		public DeleteSentence DeleteStatement  { get; }

		public DeleteContext(IClauseContext querySequence, DeleteTypeEnum deleteType,
			LambdaExpression? outputExpression, DeleteSentence deleteStatement, IClauseContext? deletedContext)
