...
namespace mooSQL.linq.Linq.Builder
{
	...
	class SelectContext : ClauseContextBase
	{
		#region Init
		...
		public          IClauseContext? InnerContext  { get; }
		...
		public SelectContext(IClauseContext? parent, ClauseSqlTranslator builder, IClauseContext? innerContext, Expression body, SelectQueryClause selectQuery, bool isSubQuery)
		...
		public SelectContext(IClauseContext? parent, LambdaExpression lambda, bool isSubQuery, params IClauseContext[] sequences)
			: this(parent, SequenceHelper.PrepareBody(lambda, sequences), sequences[0], sequences[0].SelectQuery, isSubQuery)
		{

		}

		public SelectContext(IClauseContext? parent, Expression body, IClauseContext innerContext, bool isSubQuery)
			: this(parent, body, innerContext, innerContext.SelectQuery, isSubQuery)
		{

		}

		public SelectContext(IClauseContext? parent, Expression body, IClauseContext innerContext, SelectQueryClause selectQuery, bool isSubQuery)
