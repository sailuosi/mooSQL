...
namespace mooSQL.linq.Linq.Builder
{
	...
	internal sealed class DefaultIfEmptyContext : SequenceContextBase
	{
		...
		internal DefaultIfEmptyContext(IBuildContext? parent, IBuildContext sequence, IBuildContext nullabilitySequence, Expression? defaultValue, bool allowNullField, bool isNullValidationDisabled)
		...
		internal static ReadOnlyCollection<Expression>? PrepareNoNullConditions(ClauseSqlTranslator builder, IBuildContext notNullHandlerSequence, IBuildContext sequence, IBuildContext nullabilitySequence, bool allowNullField)
		{
