...
namespace mooSQL.linq.Linq.Builder
{
	...
	sealed class DropBuilder : MethodCallBuilder
	{
		...
		protected override BuildSequenceResult BuildMethodCall(ExpressionBuilder builder, MethodCallExpression methodCall, BuildInfo buildInfo)
		{
			...
			return BuildSequenceResult.FromContext(new DropContext(buildInfo.Parent, sequence, new DropTableSentence(sequence.SqlTable)));
		}
		...
		sealed class DropContext : SequenceContextBase
		{
			...
			public DropContext(IBuildContext? parent, IBuildContext sequence,
				DropTableSentence         dropTableStatement)
