...
namespace mooSQL.linq.Linq.Builder
{
	...
	internal sealed partial class MergeBuilder : MethodCallBuilder
	{
		...
		public static SelectQueryClause ReplaceSourceInQuery(SelectQueryClause query, TableWord toReplace, TableWord replaceBy)
		{
		...
		public static TableWord? GetTargetTable(IBuildContext target)
		{
