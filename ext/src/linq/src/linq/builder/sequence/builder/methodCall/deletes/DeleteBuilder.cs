	...
	sealed class DeleteBuilder : MethodCallBuilder
	{
		...
		protected override BuildSequenceResult BuildMethodCall(ExpressionBuilder builder, MethodCallExpression methodCall, BuildInfo buildInfo)
		{
			...
			if (deleteType != DeleteContext.DeleteTypeEnum.Delete)
			{
				...
				deletedContext = new TableBuilder.TableContext(builder, sequence.Builder.DBLive, outputSelectQuery, deletedTable as TableWord, false);

				if (builder.DBLive.dialect.Option.ProviderFlags.OutputDeleteUseSpecialTable)
				{
					deletedContext = new AnchorContext(null,
						new TableBuilder.TableContext(builder, sequence.Builder.DBLive, outputSelectQuery, deletedTable as TableWord, false),
