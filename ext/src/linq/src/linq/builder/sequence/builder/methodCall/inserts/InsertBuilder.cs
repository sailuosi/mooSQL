...
namespace mooSQL.linq.Linq.Builder
{
	...
	sealed class InsertBuilder : MethodCallBuilder
	{
		...
		protected override BuildSequenceResult BuildMethodCall(ExpressionBuilder builder, MethodCallExpression methodCall, BuildInfo buildInfo)
		{
			...
			if (methodCall.Arguments.Count > 0)
			{
				...
				if (insertType is InsertContext.InsertTypeEnum.InsertOutput or InsertContext.InsertTypeEnum.InsertOutputInto)
				{
					...
					insertContext.OutputContext = new TableBuilder.TableContext(builder, builder.DBLive, new SelectQueryClause(), insertedTable, false);
		...
		public sealed class InsertContext : PassThroughContext
		{
			...
			public InsertContext(IBuildContext querySequence, InsertTypeEnum insertType, InsertSentence insertStatement, LambdaExpression? outputExpression)
			...
			public void FinalizeSetters()
			{
				...
				{
					//var expr = Builder.DataContext.CreateSqlProvider().GetIdentityExpression(insert.Into as TableWord);
		...
		internal sealed class Into : MethodCallBuilder
		{
				...
				MethodCallExpression                                                 methodCall, BuildInfo buildInfo)
			{
				...
				insertStatement = new InsertSentence(sequence.SelectQuery);
