...
namespace mooSQL.linq.Linq.Builder
{
	...
	sealed class UpdateBuilder : MethodCallBuilder
	{
		...
		static void ExtractSequence(BuildInfo buildInfo, ref IBuildContext sequence, out UpdateContext updateContext)
		{
			...
			{
				updateContext = new UpdateContext(sequence, UpdateTypeEnum.Update, new UpdateSentence(sequence.SelectQuery));
			}
		...
		public static (IBuildContext deleted, IBuildContext inserted, TableWord deletedTable, TableWord insertedTable) CreateDeletedInsertedContexts(ExpressionBuilder builder, ITableContext targetTableContext, out IBuildContext outputContext)
		{
			...
			{
				insertedContext = new TableBuilder.TableContext(builder,builder.DBLive, outputSelectQuery, targetTableContext.SqlTable, false);
				deletedContext  = new TableBuilder.TableContext(builder, builder.DBLive, outputSelectQuery, targetTableContext.SqlTable, false);
			}
		...
		public sealed class UpdateContext : PassThroughContext
		{
			...
			public UpdateContext(IBuildContext querySequence, UpdateTypeEnum updateType, UpdateSentence updateStatement)
