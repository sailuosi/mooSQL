...
namespace mooSQL.data
{
    ...
    internal class TypeDeserializerCache
    {
        ...
        internal static Func<DbDataReader, DBInstance, object> GetReader(Deserializer deserializer, Type type, DbDataReader reader, int startBound, int length, bool returnNullIfFirstMissing,DBInstance db=null)
        {
            ...
            return found.GetReader(deserializer,reader, startBound, length, returnNullIfFirstMissing, db);
        }

        private readonly Dictionary<DeserializerKey, Func<DbDataReader, DBInstance, object>> readers = new Dictionary<DeserializerKey, Func<DbDataReader, DBInstance, object>>();
