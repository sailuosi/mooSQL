...
namespace mooSQL.data
{
    ...
    {
        public IReadOnlyList<string> PartitionExpressions { get; set; } = ArrayCache.Empty<string>();
        public IReadOnlyList<WindowOrderItem> OrderItems { get; set; } = ArrayCache.Empty<WindowOrderItem>();
