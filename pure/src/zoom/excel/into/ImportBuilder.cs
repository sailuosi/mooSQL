...
namespace mooSQL.excel
{
    ...
    public class ImportBuilder
    {
        ...
        /// <param name="logtips"></param>
        /// <param name="batchUpdate"></param>
        /// <param name="title"></param>
        /// <param name="outInfoCol"></param>
        /// <param name="mode"></param>
        /// <param name="titleRowNum"></param>
        /// <param name="dataRowNum"></param>
        /// <param name="demoUrl"></param>
        /// <param name="note"></param>
        /// <param name="saveMsgToExcel"></param>
        /// <param name="ignoreCase"></param>
        /// <param name="logColNum"></param>
        /// <param name="titleScanScope"></param>
        /// <param name="titleScanReg"></param>
        /// <returns></returns>
