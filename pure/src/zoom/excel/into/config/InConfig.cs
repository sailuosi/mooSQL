...
namespace mooSQL.excel {
    ...
    public class InConfig
    {
        ...
        /// <summary>
        /// 向全局键值列集合 <see cref="KVs"/> 追加一列配置（字段、来源、校验、动态等），参数与导入列配置一致。
        /// </summary>
        /// <param name="field">数据库字段名。</param>
        /// <param name="value">固定值或表达式。</param>
        /// <param name="key">列配置唯一键。</param>
        /// <param name="colType">列值类型字符串。</param>
        /// <param name="src">来源说明。</param>
        /// <param name="excelCol">Excel 列名。</param>
        /// <param name="excelCode">Excel 列编码。</param>
        /// <param name="codeTable">码表名。</param>
        /// <param name="failCode">失败错误码。</param>
        /// <param name="mode">写入模式字符串。</param>
        /// <param name="type">列类型字符串。</param>
        /// <param name="rule">校验规则。</param>
        /// <param name="defaultVal">默认值。</param>
        /// <param name="select">查询 SELECT 片段。</param>
        /// <param name="from">查询 FROM。</param>
        /// <param name="where">查询 WHERE。</param>
        /// <param name="reckonType">计算类型。</param>
        /// <param name="seprator">分隔符。</param>
        /// <param name="range">取值范围。</param>
        /// <param name="reg">正则。</param>
        /// <param name="splitStr">拆分源串。</param>
        /// <param name="splitResName">拆分结果列名。</param>
        /// <param name="splitHeads">拆分表头格式。</param>
        /// <param name="dynamic">是否动态列 YES/NO。</param>
        /// <param name="isNeed">是否必填 YES/NO。</param>
        /// <param name="showTip">是否显示提示 YES/NO。</param>
        /// <returns>当前配置对象，便于链式调用。</returns>
    ...
    public class InBPOMethod {
        /// <summary>BPO 服务名或类名。</summary>
        public string BPOName;
        /// <summary>要调用的方法名。</summary>
