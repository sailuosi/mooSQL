...
namespace mooSQL.excel {
    ...
    public class InTable
    {
        ...
        /// <summary>数据库连接位或数据源位置索引。</summary>
        public string position;

        /// <summary>数据行范围字符串（如 2-、3,5-10）。</summary>
        ...
        /// <summary>执行更新时附加的 WHERE 条件模板。</summary>
        ...
        /// <summary>查重失败时的提示模板，可使用占位符。</summary>
        public string repeatErrTip = "";

        /// <summary>WHERE IN 映射列配置列表（用于限制核验数据范围）。</summary>
