...
namespace mooSQL.excel
{
    ...
    public class ReadyValueCollection : BaseUtil
    {
        ...
        /// <summary>
        /// 为写入列装载值：可来自引用列或当前 Excel 行。
        /// </summary>
        /// <param name="row">当前 Excel 数据行。</param>
        /// <param name="col">目标列信息。</param>
